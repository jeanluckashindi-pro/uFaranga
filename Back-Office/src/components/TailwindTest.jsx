...
const TailwindTest = () => {
  return (
    <div className="p-8 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold mb-4">Test Tailwind CSS - Back Office</h2>
      ...
      <button className="mt-6 bg-white text-indigo-600 px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
        Bouton Test Admin
      </button>
    </div>
  );
